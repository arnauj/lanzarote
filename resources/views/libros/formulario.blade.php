...
@section('content')
    ...
    <form action="{{ route('libros.almacenar') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nombre" class="form-control" id="nombre" value="{{ old('nombre')}}" placeholder="Título">
            @error('nombre') <p style="color: red;">{{ $message }}</p> @enderror
        </div>
        <div class="mb-3">
            <label for="autor" class="form-label">Autor</label>
            <input type="text" name="autor" class="form-control" id="autor" value="{{ old('autor')}}" placeholder="Autor">
            @error('autor') <p style="color: red;">{{ $message }}</p> @enderror
        </div>
        <div class="mb-3">
            <label for="anho" class="form-label">Año</label>
            <input type="text" name="anho" class="form-control" id="anho"  value="{{ old('anho')}}" placeholder="Año">
        ...
        <div class="mb-3">
            ...
            <textarea name="descripcion" class="form-control" id="descripcion" placeholder="Descripción...">{{ old('descripcion') }}</textarea>
